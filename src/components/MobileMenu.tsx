      ...
      {isOpen && mounted && createPortal(
        <>
          ...
          <div
            ...
            className="fixed right-0 top-0 z-[101] h-full w-64 transform border-l border-white/10 bg-surface shadow-2xl backdrop-blur-xl transition-transform duration-300 ease-in-out"
          >
